...
class CaroEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=-1, high=1, shape=(self.board_size, self.board_size), dtype=np.int8)  # không gian quan sát là một ma trận 3x3 với các giá trị từ 0 đến 2
    ...
    def step(self, row, col):
        if self.board[row][col] != 0:  # kiểm tra nước đi hợp lệ
            return self._get_obs(), -1000, False, {}
    ...
    # Tạo lại ván cờ mới
    def reset(self):
        self.board = np.zeros((3, 3))  # khởi tạo lại bàn cờ
...
class DQNAgent:
    ...
    def replay(self, batch_size):
        ...
        if self.epsilon > self.epsilon_min:
            ...
            with open('logs/num_epsilon_v1_v'+version_log+'.txt', mode='w') as f:
